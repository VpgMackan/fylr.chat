      ...
      <div className="p-6 w-full">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center">
            <button
              onClick={() => router.back()}
              className="mr-4 p-2 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg transition-all"
              aria-label="Go back"
            >
          ...
          >
            <Icon icon="mdi:folder-edit" className="text-xl" />
            Manage Sources
          </button>
        </div>
